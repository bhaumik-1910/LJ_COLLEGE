...
const superAdminLinks = [
  ...
  { id: 6, title: 'Institution', image: iconsImgs.users, path: '/superadmin-dashboard/institution' },
  { id: 7, title: 'Institution List', image: iconsImgs.users, path: '/superadmin-dashboard/institution-list' },

  { id: 8, title: 'Document', image: iconsImgs.document, path: '/superadmin-dashboard/document' },
  { id: 9, title: 'Super Admin', image: iconsImgs.admin, path: '/superadmin-dashboard/superadmin' },
...
const AdminLinks = [
  ...
  { id: 2, title: 'Add Faculty', image: iconsImgs.add, path: '/admin-dashboard/add-faculty' },
  // { id: 3, title: 'Student List', image: iconsImgs.list, path: '/admin-dashboard/student-list' },
  { id: 3, title: 'Faculty List', image: iconsImgs.faculty, path: '/admin-dashboard/faculty-list' },
  { id: 4, title: 'Document List', image: iconsImgs.document, path: '/admin-dashboard/document-list' },
  { id: 5, title: 'Profile', image: iconsImgs.profile, path: '/admin-dashboard/profile' },
...
const facultyLinks = [
  { id: 1, title: 'Dashboard', image: iconsImgs.home, path: '/faculty-dashboard' },
  // { id: 2, title: 'Add Student', image: iconsImgs.add, path: '/faculty-dashboard/add-student' },
  { id: 2, title: 'Add Document', image: iconsImgs.add_d, path: '/faculty-dashboard/add-document' },
  // { id: 4, title: 'Student List', image: iconsImgs.list, path: '/faculty-dashboard/student-list' },
  { id: 3, title: 'Document List', image: iconsImgs.document, path: '/faculty-dashboard/document-list' },
  { id: 4, title: 'Profile', image: iconsImgs.profile, path: '/faculty-dashboard/profile' },
  { id: 5, title: 'Logout', image: iconsImgs.logout, path: '/logout' },
];
