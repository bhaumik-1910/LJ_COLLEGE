...
//                             >
//                                 <Card variant="outlined" sx={{ p: 1, boxShadow: '0 2px 8px rgba(2,6,23,0.06)', width: '180%' }}>
//                                     <CardContent sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: 'auto 1fr auto' }, alignItems: 'center', gap: 2 }}>
//                                         <Typography variant="subtitle1" fontWeight={800} color="warning.main" sx={{ minWidth: 64 }}>
//                                             {n.date}
//                                         </Typography>
//                                         <Box>
