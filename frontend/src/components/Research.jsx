            ...
            <Container>
                ...
                <Grid container spacing={4} alignItems="center">
                    <Grid item xs={12} md={5}>
                        ...
                        >
                            <Typography variant="overline" sx={{ letterSpacing: '.2em', color: 'secondary.main', fontWeight: 800 }}>
                                Research
                            </Typography>
                            <Typography variant="h4" sx={{ fontWeight: 800, mt: 0.5 }}>
                                Advancing knowledge for real-world impact
                            </Typography>
                            <Typography color="text.secondary" sx={{ mt: 1 }}>
                                Our research centers drive innovation across disciplines, partnering with industry and communities.
                            </Typography>
                            <Box component="ul" sx={{ mt: 2, pl: 0, listStyle: 'none', display: 'grid', gap: 1.25 }}>
                                {highlights.map((h, i) => (
                                    <Box key={i} component="li" sx={{ position: 'relative', pl: 3 }}>
                        ...
                        >
                            <Box
                                sx={{
                                    ...
                                    border: '1px solid',
                                    // borderColor: 'divider',
                                    backgroundImage: `url(https://images.unsplash.com/photo-1529101091764-c3526daf38fe?q=80&w=2000&auto=format&fit=crop)`,
                                    backgroundSize: 'cover',
                                    // backgroundPosition: 'center',
                                    boxShadow: '0 16px 40px -16px rgba(2,6,23,0.2)',
                                }}
                            />
                        </motion.div>
                    </Grid>
