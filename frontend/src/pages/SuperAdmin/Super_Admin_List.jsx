        ...
        <Dialog open={editOpen} onClose={() => setEditOpen(false)} fullWidth maxWidth="sm">
          ...
          <DialogContent dividers>
            <Stack spacing={2}>
              ...
              <TextField select margin="dense" label="Role" variant="outlined" fullWidth value={editRow?.role || "admin"} onChange={(e) => onEditChange("role", e.target.value)}>
                <MenuItem value="admin">Admin</MenuItem>
                <MenuItem value="faculty">Faculty</MenuItem>
                <MenuItem value="student">Student</MenuItem>
                <MenuItem value="user">User</MenuItem>
              </TextField>
              <TextField margin="dense" label="University" variant="outlined" fullWidth value={editRow?.university || ""} onChange={(e) => onEditChange("university", e.target.value)} />
            </Stack>
          </DialogContent>
          <DialogActions>
            <Button onClick={() => setEditOpen(false)}>Cancel</Button>
