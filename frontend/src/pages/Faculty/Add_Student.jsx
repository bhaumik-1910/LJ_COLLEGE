...
//     return (
//         <Box component="form" onSubmit={onSubmit} sx={{ p: 3, maxWidth: 600, mx: 'auto',minHeight:'100vh',width:'100%' }}>
                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            <Box component="form" onSubmit={onSubmit} sx={{ 
                                ...
                                <Grid container spacing={isMobile ? 2 : 3} direction="column">
                                    <Grid item xs={12}>
                                        <TextField label="Enrollment No" name="enrolno" value={form.enrolno} onChange={handleChange} fullWidth variant="standard" size="medium" />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TextField label="Full Name" name="fullName" value={form.fullName} onChange={handleChange} fullWidth variant="standard" size="medium" />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TextField type="email" label="Email" name="email" value={form.email} onChange={handleChange} fullWidth variant="standard" size="medium" />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TextField label="Contact" name="contact" value={form.contact} onChange={handleChange} fullWidth inputProps={{ maxLength: 10 }} variant="standard" size="medium" />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TextField select label="Gender" name="gender" value={form.gender} onChange={handleChange} fullWidth variant="standard" size="medium">
                                            <MenuItem value="male">Male</MenuItem>
                                            <MenuItem value="female">Female</MenuItem>
                                        </TextField>
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TextField select label={fetchingUnis ? "Loading Universities..." : "University"} name="university" value={form.university} onChange={handleChange} fullWidth variant="standard" disabled={fetchingUnis || universities.length === 0} size="medium">
                                            {universities.map((u) => (
                                                <MenuItem key={u._id} value={u.name}>
                                                    {u.name}
                                                </MenuItem>
