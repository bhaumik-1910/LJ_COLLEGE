...
//             // Optional: keep header avatar in sync if your header reads from localStorage
//             try { localStorage.setItem("avatarUrl", form.avatarUrl || ""); } catch { }
...
//     return (
//         <Box sx={{ p: 3 }}>
//             <Typography variant="h5" fontWeight={700} mb={2}>Sub Admin Profile</Typography>
//             <Grid sx={{ p: 3 }}>
    ...
    try {
      ...
      window.dispatchEvent(
        new CustomEvent("profile:updated", {
          detail: { avatarUrl: form.avatarUrl || "" },
        })
      );
      await fetchMe();
    } catch (e) {
                ...
                <Box width="100%" mt={1}>
                  <Button
                    ...
                    sx={{
                      textTransform: "none",
                      borderRadius: 3,
                      bgcolor: "linear-gradient(90deg,#4f73ff,#7fb1ff)",
              ...
              <Stack spacing={2}>
                ...
                <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
                  <TextField
                    ...
                    disabled // role is read-only as before
                    fullWidth
                    variant="outlined"
                    InputProps={{
                      sx: { borderRadius: 3, bgcolor: "#fbfcff" },
                    }}
                  />
                  <TextField
                    label="University"
